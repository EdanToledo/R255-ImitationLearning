...
D4RL_DATASET_NAMES = {
    "HalfCheetah-v2": "d4rl_mujoco_halfcheetah/v2-expert",
    "Ant-v2": "d4rl_mujoco_ant/v2-expert",
    "Walker2d-v2": "d4rl_mujoco_walker2d/v2-expert",
    "Hopper-v2": "d4rl_mujoco_hopper/v2-expert",
}


def get_dataset_name(env_name: str) -> str:
    return D4RL_DATASET_NAMES[env_name]
