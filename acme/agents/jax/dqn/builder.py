...
class DQNBuilder(
    builders.ActorLearnerBuilder[
        dqn_networks.DQNNetworks, dqn_actor.DQNPolicy, utils.PrefetchingSplit
    ]
):
    """DQN Builder."""
    ...
    def make_learner(
        ...
        return learning_lib.SGDLearner(
            ...
            optimizer=optax.adam(self._config.learning_rate, eps=self._config.adam_eps),
    ...
    def make_policy(
        ...
        def get_action_values(
            ...
            **kwargs,
            ...
            return networks.policy_network.apply(params, observation, *args, **kwargs)[
                0
            ]
