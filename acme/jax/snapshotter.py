...
class JAXSnapshotter(core.Worker):
    ...
    def __init__(
        ...
        models: Dict[str, Callable[[core.VariableSource], types.ModelToSnapshot]],
        path: str,
    ...
    def _get_models_and_paths(
        self, path: str
    ) -> Sequence[Tuple[types.ModelToSnapshot, str]]:
    ...
    def _snapshot_model(self, model: types.ModelToSnapshot, saving_path: str) -> None:
