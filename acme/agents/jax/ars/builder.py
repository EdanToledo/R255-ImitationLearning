...
def get_policy(
    policy_network: networks_lib.FeedForwardNetwork, normalization_apply_fn
    ...
    def apply(
        ...
        return action, {
            "params_key": jax.tree_map(lambda x: jnp.expand_dims(x, axis=0), params_key)
        }
...
class ARSBuilder(
    ...
    def make_actor(
        ...
        variable_client = variable_utils.VariableClient(
            variable_source, kname, device="cpu"
        )
